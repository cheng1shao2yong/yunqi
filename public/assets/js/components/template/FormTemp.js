...
<div class="form-body">
    ...
    <el-form :require-asterisk-position="requireAsteriskPosition" ref="formRef" :model="form_.data" :label-position="documentWidth<=600?'top':labelPosition" :label-width="labelWidth"  :rules="form_.rules">
        ...
        <template v-for="(column,key) in form_.columns">
            ...
            <template v-if="column.edit && column.edit.form!='slot'">
            <el-form-item :prop="column.field" :label="column.title+':'" :error="column.edit.error" :class="((steps && column.step!=activeStep) || column.edit.visible===false || (column.edit.form=='input' && column.edit.type=='hidden'))?'hide':''">        
                 <el-row style="width:100%">
                    <el-col :span="24-appendWidth">
                        ...
                        <el-input @blur="column.edit.blur(form_.data[column.field],form_.data)" :disabled="column.edit.readonly" v-model="form_.data[column.field]" v-if="column.edit.form=='input'" :type="column.edit.type" :rows="(column.edit.type=='textarea')?column.edit.rows:''" :placeholder="column.edit.placeholder">
                        ...
                        <el-select @change="column.edit.change(form_.data[column.field],form_.data)" :placeholder="column.edit.placeholder" v-model="form_.data[column.field]" :multiple="column.edit.multiple?true:false" :clearable="column.edit.clearable?true:false" v-if="column.edit.form=='select'" style="width: 100%">
                            <el-option
                        ...
                        <el-upload
                            ...
                            :data="{disks:column.edit.disks,category:''}"
                        ...
                        <template v-if="column.edit.form=='fieldlist'">
                            <Fieldlist :label="column.edit.label" :value="form_.data[column.field]" @change="changeFieldlist" :field="column.field"></Fieldlist>
                        </template>
                    </el-col>
